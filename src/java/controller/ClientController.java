...
public class ClientController implements Serializable {
    ...
    private List<Client> cliens = null;
    private List<DemandePoules> demandes = null;
    private Client selected;
 

    private List<Client> clientItems = new ArrayList<>();
    ...
    public void setCliens(List<Client> cliens) {
        this.cliens = cliens;
    }
    ...
    public void setEjbFacade(ClientFacade ejbFacade) {
    ...
    public void setClientItems(List<Client> clientItems) {
